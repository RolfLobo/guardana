...
Version 9 records what a suite measured over its dataset and what its gate concluded
(`rules[].suite`), with the pass rate corrected for its judge's error or why not.
"""
