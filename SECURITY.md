...
gh attestation verify oci://ghcr.io/guardana/guardana:0.27 --repo guardana/guardana
docker buildx imagetools inspect ghcr.io/guardana/guardana:0.27 --format '{{ json .SBOM }}'
```
